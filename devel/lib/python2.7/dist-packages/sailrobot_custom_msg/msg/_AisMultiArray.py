...
"""autogenerated by genpy from sailrobot_custom_msg/AisMultiArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import sailrobot_custom_msg.msg
import std_msgs.msg

class AisMultiArray(genpy.Message):
  _md5sum = "9b970ad182fe4ed91c6d7ee1db87e99b"
  _type = "sailrobot_custom_msg/AisMultiArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#Message of type AIS Multy Array
...
"""
  ...
  _slot_types = ['std_msgs/MultiArrayLayout','sailrobot_custom_msg/Ais[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AisMultiArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.data = []
      for i in range(0, length):
        val1 = sailrobot_custom_msg.msg.Ais()
        _v3 = val1.header
        start = end
        end += 4
        ...
        if python3:
          val1.position_accuracy = str[start:end].decode('utf-8')
        else:
          val1.position_accuracy = str[start:end]
        _x = val1
        start = end
        end += 40
